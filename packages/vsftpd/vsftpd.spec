# $Owl: Owl/packages/vsftpd/vsftpd.spec,v 1.22 2006/06/05 22:27:50 ldv Exp $
...
Patch0: vsftpd-2.0.4-owl-warnings.diff
Patch1: vsftpd-2.0.3-owl-pam_userpass.diff
Patch2: vsftpd-2.0.3-owl-alt-defaults.diff
