# $Owl: Owl/packages/bind/bind.spec,v 1.29.4.2 2016/10/24 03:00:59 solar Exp $
...
%changelog
* Mon Oct 24 2016 Solar Designer <solar-at-owl.openwall.com> 9.3.5-owl7.3.1.2
- Added patches from bind-9.3.6-25.P1.el5_11.10 for CVE-2015-5722 (likely
unneeded since DNSSEC-specific), CVE-2015-8000, CVE-2015-8704, CVE-2016-1285
and CVE-2016-1286, CVE-2016-2776, CVE-2016-2848.
