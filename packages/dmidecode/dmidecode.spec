# $Owl: Owl/packages/dmidecode/dmidecode.spec,v 1.1 2009/06/14 19:36:47 mci Exp $
...
%description
dmidecode reports information about x86 & x86_64 hardware as described in the
